...
export default function BrandDashboard() {
  ...
  function onSubmit(data: z.infer<typeof FormSchema>) {
    ...
    toast("You submitted a new challenge");
  }
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Choose whether this challenge should be &ldquo;Active&rdquo;
                  or &ldquo;Inactive&rdquo;.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  Provide a clear overview of the challenge: goals, rules, and
