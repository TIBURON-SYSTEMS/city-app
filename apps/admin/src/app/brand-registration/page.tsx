...
export default function BrandForm({ userId }: BrandFormProps) {
  ...
  const onSubmit = async (data: FormData) => {
    ...
    try {
      ...
      setApiError(err.message || 'An unexpected error occurred during brand creation.');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  return (
    <Card className="w-full max-w-md shadow-2xl">
      <CardHeader className="space-y-1 text-center">
        ...
        <CardTitle className="text-3xl font-bold tracking-tight">Register Your Brand</CardTitle>
